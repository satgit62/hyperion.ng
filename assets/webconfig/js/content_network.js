$(document).ready(function () {
  ...
  conf_editor_json.on('ready', function () {
    ...
    console.log("conf_editor_forw", conf_editor_forw);
    updateJsonEditorMultiSelection(conf_editor_forw, "root.forwarder", "json", addSchemaElements, enumVals, enumTitelVals, enumDefaultVals);
  ...
  if (storedAccess != 'default') {
    ...
    conf_editor_forw.on('ready', function () {
      ...
      updateJsonEditorMultiSelection(conf_editor_forw, "root.forwarder", "flat", addSchemaElements, enumVals, enumTitelVals, enumDefaultVals);
