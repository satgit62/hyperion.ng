...
$(document).ready(function () {
  ...
  $("#log_upl_pol").append('<span style="color:grey;font-size:80%">' + $.i18n("conf_logging_uplpolicy") + ' ' + buildWL("user/advanced/Support.html#report-privacy-policy", $.i18n("conf_logging_contpolicy")));
